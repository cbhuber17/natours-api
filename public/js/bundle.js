...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2JodWJlciIsImEiOiJjbGc1bGhkdWIwNDJ2M3JxaTlndnd3c3lyIn0.byXfAcSD956iJTLKMcRSgQ';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MvkFRFs5RhKxgWtysVk4GGjoK3WqGLLu8gXoyX1IXx1ChCkhiWNrVq2EU0m0jtkwmcgQFomR3BY1f97ZQFvHLiH00GvhX9k6E');
          _context.prev = 1;
          _context.next = 4;
